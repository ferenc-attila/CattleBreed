...
class CattleRegistrationTest {
    ...
    void createOnlyWithDateOfIncomingTest() {
        CattleRegistration registration = new CattleRegistration(LocalDate.parse("2022-01-01"), CauseOfIncoming.REPRODUCTION);
    ...
    void copyConstructorTest() {
        CattleRegistration initRegistration = new CattleRegistration(125, "BKE 123456", LocalDate.parse("2022-01-01"), CauseOfIncoming.REPRODUCTION, LocalDate.parse("2022-01-08"));
