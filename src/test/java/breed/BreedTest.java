...
class BreedTest {
    ...
    void init() {
        ...
        CattleProperties secondProperties = new CattleProperties("RRS",
                ...
                "HU 2345 2345 24",
                "Szelíd");
        CattleRegistration secondRegistration = new CattleRegistration(126, "BKE 123457", LocalDate.parse("2022-01-01"), LocalDate.parse("2022-01-08"));
        ...
        CattleProperties thirdProperties = new CattleProperties("RRR",
                ...
                "HU 2345 2345 29",
                "Nagy marmagasságú");
        CattleRegistration thirdRegistration = new CattleRegistration(127, "BKE 123457", LocalDate.parse("2022-01-01"), LocalDate.parse("2022-01-08"));
